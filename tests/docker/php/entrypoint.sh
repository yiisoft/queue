...
tests/yii sqlite-migrate --interactive=0

tests/docker/wait-for-it.sh mysql:3306 -t 180
tests/docker/php/mysql-lock.php tests/yii mysql-migrate --interactive=0

tests/docker/wait-for-it.sh postgres:5432 -t 180
tests/docker/php/mysql-lock.php tests/yii pgsql-migrate --interactive=0
